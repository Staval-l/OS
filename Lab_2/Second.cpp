// Потоки одного процесса + синхронизация через события + передача через каналы + рассчет гипотенузы
// Данная лабораторная работает через раз
// Проблема в каналах, но как ее решить, я не понял :/
